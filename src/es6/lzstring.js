...
//
// NOTE: Originally, this file is written in EcmaScript 5, but in order to be
//       sure it won't use any function that is not supported by older browsers,
//       it was re-written for the project in EcmaScript 6 and will be
//       transpiled in EcmaScript 5 to provide a better compatibility.

/**
 * The LZString interface
 * @type {Object}
 * @constant
 */
